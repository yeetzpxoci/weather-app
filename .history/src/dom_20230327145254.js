...
function changeDailyWeatherDetails(weatherArray){
    ...
    document.querySelector(".nav-point-container").style.display = "none";
    document.getElementById("slide-left").style.display = "none";
    document.getElementById("slide-right").style.display = "none";
    document.querySelector(".daily-weather-container").style.gridTemplateColumns = "1fr 1fr 1fr 1fr 1fr";
...
function changeHourlyWeatherDetails(weatherArray, hoursArray) {
    ...
    document.querySelector(".nav-point-container").style.display = "flex";
    document.getElementById("slide-left").style.display = "block";
    document.getElementById("slide-right").style.display = "block";
    document.querySelector(".daily-weather-container").style.gridTemplateColumns = "0.5fr 1fr 1fr 1fr 1fr 1fr 0.5fr";
