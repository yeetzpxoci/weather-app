...
function changeDailyWeatherDetails(weatherArray){
    ...
    document.querySelector(".daily-weather-container2").style.transform = "translateX(2000px)";
    document.querySelector(".daily-weather-container3").style.transform = "translateX(4000px)";
