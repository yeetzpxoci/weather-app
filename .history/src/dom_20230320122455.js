...
const thunderstormBackground = "url(https://rare-gallery.com/uploads/posts/380484-4k-wallpaper.jpg)";
const rainBackground = "url(https://images.unsplash.com/photo-1613488329064-aafbeb1e4db1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8cmFpbiUyMGphcGFufGVufDB8fDB8fA%3D%3D&w=1000&q=80)"; 
const snowBackground = "url(https://wallpaper.dog/large/10850424.jpg)";
const clearBackground = "url(https://a-static.besthdwallpaper.com/buildings-of-tokyo-city-shot-on-sunny-day-wallpaper-5120x2880-92935_55.jpg)";
const cloudBackground = "url(https://c1.wallpaperflare.com/preview/586/645/192/japan-sea-winter-road-hokkaido-sea-it-was-cloudy-weather.jpg)";
...
function changeBackground(weatherCondition) {
    ...
    const thunderstorm = document.getElementById("rain");
    const thunderstorm = document.getElementById("snow");
    const thunderstorm = document.getElementById("clear");
    const thunderstorm = document.getElementById("cloud");

    switch (weatherCondition) {
        case "Thunderstorm":
            body.style.backgroundImage = thunderstormBackground;
            break;
        case "Rain":
            body.style.backgroundImage = rainBackground;
            break;
        case "Snow":
            body.style.backgroundImage = snowBackground;
            break;
        case "Clear":
            body.style.backgroundImage = clearBackground;
            break;
        case "Clouds":
            body.style.backgroundImage = cloudBackground;
            break;
        default:
