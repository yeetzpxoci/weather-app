            ...
            setTimeout(function () {
                ...
                getWeatherData(locationData[0].lat, locationData[0].lon).then(weatherData => {
                    ...
                    if (dailyActive) {
                        ...
                        hoursArray = getHours(weatherData);
                        hourlyWeatherArray = getWeatherArrayHourly(weatherData.list);
                        console.log(hourlyWeatherArray[0])
                        changeHourlyWeatherDetails(hourlyWeatherArray, hoursArray);
                    }
                })
            }, 1000);
        }
