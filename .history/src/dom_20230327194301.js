...
function changeDailyWeatherDetails(weatherArray){
    ...
    document.querySelector(".daily-weather-container2").style.transform = "translateX(1500px)";
    document.querySelector(".daily-weather-container3").style.transform = "translateX(3000px)";
...
function changeHourlyWeatherDetails(weatherArray, hoursArray) {
    ...
    const icons = document.querySelectorAll(".weather-icon-day-hour");
    const degrees = document.querySelectorAll(".degree-day-hour");
    document.querySelector(".daily-weather-container" + ).style.display = "grid";
