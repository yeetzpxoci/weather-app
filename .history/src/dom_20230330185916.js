...
function showHourlyWeatherDetails(weatherArray, hoursArray) {
    const hourlyWeatherContainer1 = document.createElement("div");
    hourlyWeatherContainer1.classList.add("hourly-weather-container");

    const hourlyWeatherContainer2 = document.createElement("div");
    hourlyWeatherContainer2.classList.add("hourly-weather-container");
    hourlyWeatherContainer2.style.transform = "translateX(2000px)"

    const hourlyWeatherContainer3 = document.createElement("div");
    hourlyWeatherContainer3.classList.add("hourly-weather-container");
    hourlyWeatherContainer3.style.transform = "translateX(4000px)"
    ...
    for (let i = 0; i < 15; i++) {
        ...
        dayHour.innerText = hoursArray[i];
