...
document.getElementById("slide-left").addEventListener("click", function () {
    ...
    const slides = document.querySelectorAll(".daily-weather-container ");

    switch (activeSlide) {
        case 0:
            slides[2].style.transform = "translate(0px)"
            slides[1].style.transform = "translate(-2000px)"
            slides[0].style.transform = "translate(-4000px)"
            break;
        case 1:
            slides[2].style.transform = "translate(4000px)"
            slides[1].style.transform = "translate(2000px)"
            slides[0].style.transform = "translate(0px)"
            break;
        case 2:
            slides[2].style.transform = "translate(2000px)"
            slides[1].style.transform = "translate(0px)"
            slides[0].style.transform = "translate(-2000px)"
            break;
