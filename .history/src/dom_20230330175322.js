...
function showDailyWeatherDetails(weatherArray){
    ...
    document.querySelector(".slide-container").appendChild(dailyWeatherContainer1);
}
...
function showHourlyWeatherDetails(weatherArray, hoursArray) {
    for (let i = 0; i < 3; i++) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            hourlyWeatherInfo.classList.add("daily-weather-info");
        ...
        document.querySelector(".slide-container").appendChild(hourlyWeatherContainer);
    }
}
