...
async function getHourlyWeatherData(lat, lon) {
    const response = await fetch('https://pro.openweathermap.org/data/2.5/forecast/hourly?lat=' + lat + '&lon=' + lon + '&appid=57a52906e330f2708af427722131c01f&units=metric', { mode: 'cors' });
