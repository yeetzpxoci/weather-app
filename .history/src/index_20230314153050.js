...
async function getWeatherData(city) {
    ...
    const weatherInfo = weather(weatherData.main.temp, weatherData.weather.main, weatherData.main.humidity, 0, weatherData.wind.speed, weatherData.main.feelsLike)
