import { getLocationData, getHourlyWeatherData, getDailyWeatherData, getWeatherObj } from "./handleAPI.js";
...
getLocationData("Amsterdam").then(locationData => {
    getHourlyWeatherData(locationData[0].lat, locationData[0].lon).then(data => {
        console.log(data);
    })
})
