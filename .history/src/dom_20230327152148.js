...
document.getElementById("slide-left").addEventListener("click", function () {
    ...
    document.querySelectorAll(".nav-point").forEach(p => p.style.backgroundColor = "rgb(208, 208, 208);");
    document.querySelector(".nav-point:nth-child(" + activeSlide + ")").style.backgroundColor = "white";
});
