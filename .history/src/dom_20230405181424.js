...
function showDailyWeatherDetails(weatherArray){
    ...
    document.querySelector(".slide-container").append(dailyWeatherContainer1);
}
...
function showHourlyWeatherDetails(weatherArray, hoursArray) {
    for (let i = 0; i < 3; i++) {
        ...
        document.querySelector(".slide-container").append(hourlyWeatherContainer);
    }
}
...
celsiusConverterButton.addEventListener("click", switchToCelsius);

fahrenheitConverterButton.addEventListener("click", switchToFahrenheit);
...
dailyButton.addEventListener("click", function () {
    ...
    if (!dailyActive) {
        ...
        setTimeout(function () {
            ...
            document.querySelector(".slide-wrapper").style.opacity = 1;
        }, 500);
